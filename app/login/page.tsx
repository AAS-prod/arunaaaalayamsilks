...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[20%] left-[-15%] w-[45%] aspect-square rounded-full bg-[#3b0a12]/20 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[-15%] w-[40%] aspect-square rounded-full bg-[#6e0e1a]/15 blur-[150px] pointer-events-none" />
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 30px 60px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.02)',
        }}
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-xs">
            Access your exclusive luxury silk showroom profile
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-4 bg-[#d4a24c] text-black font-semibold py-4 rounded-xl hover:scale-[1.01] transition duration-300 text-xs uppercase tracking-widest shadow-lg shadow-[#d4a24c]/10 disabled:opacity-60"
          >
        ...
        <div className="mt-8 text-center text-xs text-white/40 border-t border-white/5 pt-6">
          New to Arunaa Aalayam?{' '}
          <Link
            href="/signup"
            className="text-[#d4a24c] hover:underline font-medium"
          >
            Create an Account
          </Link>
        </div>
