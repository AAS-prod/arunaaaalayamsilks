...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log('Premium Login Attempt:', formData);
    // Authentication logic can be integrated here later
  };
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-xs">Access your exclusive luxury silk showroom profile</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center px-1">
              ...
              <a href="#" className="text-[#d4a24c]/60 hover:text-[#d4a24c] text-[10px] uppercase tracking-wider transition duration-200">
                Forgot?
              </a>
            </div>
            <input 
        ...
        <div className="mt-8 text-center text-xs text-white/40 border-t border-white/5 pt-6">
          ...
          <Link href="/signup" className="text-[#d4a24c] hover:underline font-medium">
            Create an Account
          </Link>
        </div>
